...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['send_reply'])) {
        ...
        if (!empty($message)) {
            ...
            redirect("view_ticket.php?id=$ticket_id", "Reply Sent");
        }
    }
    ...
    if (isset($_POST['update_ticket'])) {
        ...
        redirect("view_ticket.php?id=$ticket_id", "Ticket Updated");
    }
}

$page_title = "Manage Ticket #$ticket_id";
        ...
        <div class="col-md-8">
            ...
            <div class="replies mb-4">
                <?php foreach($all_replies as $reply): ?>
                    <div class="card mb-3 shadow-sm border-0 <?php echo $reply['sender_type'] == 'user' ? 'bg-light me-5' : 'bg-primary text-white ms-5'; ?>">
